@testset "Types & Construction" begin
    ...
    @testset "Temporal priority ordering" begin
        ...
        @test Backtest._temporal_priority(Immediate()) <
            Backtest._temporal_priority(CurrentOpen())
        @test Backtest._temporal_priority(CurrentOpen()) <
            Backtest._temporal_priority(CurrentClose())
        @test Backtest._temporal_priority(CurrentClose()) <
            Backtest._temporal_priority(NextOpen())
        @test Backtest._temporal_priority(NextOpen()) <
            Backtest._temporal_priority(NextClose())
    end
